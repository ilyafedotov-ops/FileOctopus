...
| D — Git Intelligence V1                | **In progress**    | `crates/git-intel` provides local repository discovery and porcelain status mapping with temporary-repository Rust tests                                                                                                                                                                                                                   | IPC/client/UI branch display, file badges, async cache/refresh integration; remote Git remains deferred                                        |
