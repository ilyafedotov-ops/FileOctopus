...
| UPP-L7 — first-run wizard content restructure | ✅ Done | 2026-06-12: six steps collapsed to three (Workspace → Customize → Connections); the four signpost pages became one Customize card grid; finish merged into Connections.                                                                                                                                                                                                                                                                                             |
