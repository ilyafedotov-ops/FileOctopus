...
The packaged app identifies as `com.fileoctopus.desktop`, product name `FileOctopus`, version `0.1.4`. The diagnostics panel shows version, build profile, commit SHA when supplied, target OS, data directory, log directory, and database schema version.
