...
| RC-VIDEOS    | P3  | pending  | -     | -       | -           | -                | UI_FEATURE_INVENTORY §3     | Sidebar Videos icon: backend returns `videos` standard location; frontend missing icon mapping                                                                                                            | None     | 2026-05-24    |
