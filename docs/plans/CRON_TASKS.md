...
| RC-PAUSE     | P2    | pending  | -     | -        | -           | -                | UI §6; RC spec §3.2          | Pause on jobs: backend job.pause IPC + UI pause/resume button in activity panel (PauseToken already in jobs/app-core; needs IPC handlers + UI wiring)                                              | None                                                                                                                                                                        | 2026-05-26    |
