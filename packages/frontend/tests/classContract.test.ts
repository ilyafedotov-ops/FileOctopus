...
const KNOWN_UNSTYLED = new Set([
  "fo-multi-rename-dialog",
  "fo-multi-rename-form",
  "fo-multi-rename-tokens",
  "fo-multi-rename-counter",
  "fo-multi-rename-preview",
  "fo-multi-rename-conflict-warning",
  "fo-multi-rename-results",
  "fo-multi-rename-conflict",
  "fo-multi-rename-changed",
  "fo-path-field",
  "fo-preview-pdf",
  "fo-session-manager-dialog",
  "fo-session-list",
  "fo-session-item",
  "fo-session-info",
  "fo-session-meta",
  ...
  "fo-doc",
  "fo-network-locations-dialog",
  "fo-network-empty",
  "fo-network-profile-list",
  "fo-network-profile-item",
  "fo-network-profile-main",
  "fo-network-profile-icon",
  "fo-network-profile-title",
  "fo-network-profile-meta",
  "fo-network-profile-status",
  "fo-network-profile-status-connected",
  "fo-network-profile-status-error",
  "fo-network-profile-actions",
  "fo-dialog-content",
  "fo-properties-error",
  "fo-properties-input",
  ...
  "fo-content-search",
  "fo-content-search-results",
  "fo-content-search-file",
  "fo-content-search-file-header",
  "fo-content-search-file-icon",
  "fo-content-search-file-name",
  "fo-content-search-file-path",
  "fo-content-search-file-count",
  "fo-content-search-matches",
  "fo-content-search-match",
  "fo-content-search-line-number",
  "fo-content-search-line-content",
  "fo-content-search-highlight",
  "fo-pane-editor-tab",
  "fo-pane-preview-tab",
